 ...
 * @author NideBruyn
 */
public class SprytilePlayer extends BlenderPhysics2DPlayer implements PhysicsTickListener {

    private Sprite sprite;
    private RigidBodyControl rbc;
    private SprytilePlayerShootControl playerShootControl;
...
//    private int direction = 1;
    ...
    public SprytilePlayer(BlenderPhysics2DGame blenderGame) {
        super(blenderGame);
    }
    ...
    protected void init() {
        ...
        playerShootControl = new SprytilePlayerShootControl(this);
        playerNode.addControl(playerShootControl);

        rbc.setPhysicLocation(0, 2.0f);
