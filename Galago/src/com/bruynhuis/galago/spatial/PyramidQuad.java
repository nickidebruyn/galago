 ...
 * @author nidebruyn
 */
public class PyramidQuad extends Mesh {
     ...
     */
    public PyramidQuad(float width, float height){
     ...
     * along the Y axis.
     */
    public PyramidQuad(float width, float height, boolean flipCoords){
    ...
    public void updateGeometry(float width, float height, boolean flipCoords) {
        this.width = width;
        this.height = height;
        setBuffer(Type.Position, 3, new float[]{0,      height*0.5f,      0,
