 ...
 * @author NideBruyn
 */
public class BarrelBlurFilter extends Filter {
     ...
     */
    public BarrelBlurFilter() {
        super("BarrelBlurFilter");
    ...
    protected void initFilter(AssetManager manager, RenderManager renderManager, ViewPort vp, int w, int h) {
        material = new Material(manager, "Resources/filters/barrel-blur.j3md");
    }
