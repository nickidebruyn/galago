 ...
 *
 * Controls: - Move (or, in drag-to-rotate mode, drag) the mouse to rotate the
 * camera - Mouse wheel for zooming in or out - WASD keys for moving
 * forward/backward and strafing - QZ keys raise or lower the camera
 */
public class EditorFlyCamera implements AnalogListener, ActionListener {
     ...
     */
    public EditorFlyCamera(Camera cam) {
        this.cam = cam;
    ...
    public void registerWithInput(InputManager inputManager) {
        ...
        inputManager.addMapping(CameraInput.FLYCAM_ROTATEDRAG, new MouseButtonTrigger(MouseInput.BUTTON_RIGHT)); //In the editor we use the mouse right button to rotate the fly camera
