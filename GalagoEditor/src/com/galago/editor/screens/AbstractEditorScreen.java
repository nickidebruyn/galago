...
import com.galago.editor.ui.EditPanel;
import com.galago.editor.ui.SettingsPanel;
...
//        SpatialUtils.addSkySphere(sceneNode, 2, camera);
        baseApplication.getViewPort().setBackgroundColor(ColorUtils.rgb(136,136,136));
        ...
        SpatialUtils.addColor(groundPlane, ColorUtils.rgb(136,136,136), true);
